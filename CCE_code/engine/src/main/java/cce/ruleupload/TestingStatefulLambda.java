...
public class TestingStatefulLambda {
	long lambda_ts = 0;
	...
	public static void main(String args[]) {
		new TestingStatefulLambda().handleRequest(null);
	}

	public String handleRequest(List<HashMap<String, String>> eventBatch) {
	...
	private ArrayList<String> getAlert(String rc_id, String timeframe) {
		...
		System.out.println("getAlert / itemsList: " + itemsList.toString());
		return itemsList;
	}
	...
	private void createAlarm(ArrayList<String> events, String ruleInfo, String cr_id, String severity) {
		...
		Item item = new Item()
		    ...
		    .withString("events", concatEvents)
		...
		countAlarms++;
		alarms.add(cr_id);
		System.out.println("Creating Alarm with: " + cr_id + " - " + ruleInfo + " - " + events.toString());
	}
}